                            ...
                            <div class="login_wrap widget-taber-content background-white">
                                <div class="padding_eight_all bg-white">
                                    ...
                                    <form method="POST" action="{{ route('user.add') }}">
                                        ...
                                        <!-- email  -->
                                        <div class="form-group">
                                            <input type="text" required="" name="uemail" placeholder="Email" />
                                        </div>
                                        <!-- password  -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group mb-30">
                                            <button type="submit" value="submit" class="btn btn-fill-out btn-block hover-up font-weight-bold">Submit &amp; Register</button>
                                        </div>
