                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ (empty($vendorData->photo)) ? url('/backend/vendor/avatar.png') : url('/backend/vendor/uploads/'.$vendorData->photo)}}"
                            ...
                            <form action="{{ route('vendor.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 text-center text-secondary">
                                        <img src="{{ (!empty($vendorData->photo)? url('backend/vendor/uploads/'.$vendorData->photo): url('backend/vendor/avatar.png')) }}" alt="" id="show_image" height="120" width="120">
                                    </div>
                                </div>
